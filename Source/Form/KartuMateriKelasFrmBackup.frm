...
Begin VB.Form KartuMateriKelasFrmBackup 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid3 
         ...
         FormatString    =   $"KartuMateriKelasFrmBackup.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KartuMateriKelasFrmBackup.frx":00DA
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KartuMateriKelasFrmBackup.frx":00F6
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KartuMateriKelasFrmBackup.frx":0112
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid2 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"KartuMateriKelasFrmBackup.frx":012E
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Label Label2 
         Alignment       =   2  'Center
         Caption         =   "Pilih Level Detail dan Double Click dibaris Yang Akan di Entry Hasil Test !!!"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid1 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"KartuMateriKelasFrmBackup.frx":02E6
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "KartuMateriKelasFrmBackup"
...
For irow = 1 To .Rows - 1
    ...
    If .TextMatrix(irow, .Cols - 8) = 1 Then
        .TextMatrix(irow, .Cols - 6) = 2
...
Case 2
            If Not Text1(2) = "" Then
                ...
                Text1(3) = oFindByQuery("select keterangan from vmaster_kartu_materi_kelas where nokursus='" & Text1(2) & "'", parkir)
                Text1(4) = oFindByQuery("select kodelevel from vmaster_kartu_materi_kelas where nokursus='" & Text1(2) & "'", parkir)
                sdocentry = ToNumber(oFindByQuery("select docentry from vmaster_kartu_materi_kelas where nokursus='" & Text1(2) & "'", parkir))
                skodegroup = oFindByQuery("select kodegroup from vmaster_kartu_materi_kelas where nokursus='" & Text1(2) & "'", parkir)
                skodelevel = Text1(4)
                'Text1(4).SetFocus
                ShowGrid1 sdocentry, skodelevel
...
Case 6
    ...
    ogrid2.TextMatrix(ogrid2.row, 3) = Text1(Index)
Case 7
    If ogrid2.row = 0 Then Exit Sub
    ogrid2.TextMatrix(ogrid2.row, 4) = Text1(Index)
Case 8
    If ogrid2.row = 0 Then Exit Sub
    ogrid2.TextMatrix(ogrid2.row, 5) = Text1(Index)
Case 9
    If ogrid2.row = 0 Then Exit Sub
    ogrid2.TextMatrix(ogrid2.row, 6) = Text1(Index)
End Select
End Sub
...
On Error GoTo errhandler
    ...
    sQuery = sQuery & "   WHERE a.docentry='" & keyDocentry & "' and a.kodelevel='" & keyLevel & "' order by a.linenum "
...
'        .COLWIDTH(2) = .Width - (.COLWIDTH(0) + .COLWIDTH(1) + .COLWIDTH(5) + 100)
        ...
        If Not oRsDetail.EOF Then
            ...
            Do While Not oRsDetail.EOF
                ...
                .TextMatrix(i, 2) = ToText(oRsDetail("tgltest"))
...
Me.cr1.ReportFileName = App.Path + "\Reports\kartu_materi_kelas_rpt.Rpt"

Dim sKriteria As String

sKriteria = " where nokursus  between '" & ogrid3.TextMatrix(ogrid3.row, 1) & "' and '" & ogrid3.TextMatrix(ogrid3.row, 1) & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    vkartu_materi_kelas_rpt vkartu_materi_kelas_rpt1" & sKriteria
'
'
...
Public Sub ShowGridKelas(snoidsiswaQ As String)
On Error GoTo errhandler
    Dim oKon As New ADODB.Connection
    Dim oRsDetail As New ADODB.Recordset
      
    sQuery = "SELECT docentry,nokursus,tglmulai,materi,titikpangkal2 AS titikpangkal ,"
    sQuery = sQuery & "namapembimbing FROM  vmaster_kelas_rpt "
    sQuery = sQuery & " WHERE noidsiswa='" & snoidsiswaQ & "' order by noidsiswa "
    ...
    With ogrid3
        ...
        If Not oRsDetail.EOF Then
            ...
            Do While Not oRsDetail.EOF
                ...
                .TextMatrix(i, 1) = RTrim(oRsDetail("nokursus"))
                .TextMatrix(i, 2) = ToText(oRsDetail("tglmulai"))
                .TextMatrix(i, 3) = RTrim(oRsDetail("materi"))
                .TextMatrix(i, 4) = (oRsDetail("titikpangkal"))
                .TextMatrix(i, 5) = RTrim(oRsDetail("namapembimbing"))
...
On Error GoTo errhandler
    ...
    If oKon.State = 1 Then oKon.Close
        ...
        sQuery = sQuery & " INNER JOIN master_default_pelajaran b ON a.kodegroup=b.kodegroup AND a.status='2' AND docentry=" & sDocentryQ
