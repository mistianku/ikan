...
Begin VB.Form JualFeeSalesPurchaseCustomerRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Fee Customer Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "JualFeeSalesPurchaseCustomerRpt.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "JualFeeSalesPurchaseCustomerRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "JualFeeSalesPurchaseCustomerRpt"
...
sTitle = "Fee Sales Purchase Customer Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnJualFeeCustomerRpt
End Sub
...
sQuery = "call sp_transaksi_fee_sales_purchase_rpt('"
...
If oFindByQuery(sQuery & "1)", DBaseConection.Modul) = 0 Then
    ...
    Exit Sub
End If
With arJualFeeSalesPurchaseCustomerRpt
    .lblHeaderTrx = "Report Fee Customer"
