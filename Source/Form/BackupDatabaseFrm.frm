...
Begin VB.Form BackupDatabaseFrm 
   BackColor       =   &H00FFC0C0&
   ...
   Begin VSDFLATS.FlatButton FlatButton1 
      ...
      _ExtentX        =   20770
      _ExtentY        =   661
      MouseIcon       =   "BackupDatabaseFrm.frx":0000
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "BackupDatabaseFrm.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VSDFLATS.FlatButton FlatButton1 
      ...
      _ExtentX        =   20770
      _ExtentY        =   661
      MouseIcon       =   "BackupDatabaseFrm.frx":0038
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "BackupDatabaseFrm"
...
On Error GoTo errhandler
    ...
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnBackupDatabaseFrm
    End If
    oCon.Close
    Exit Sub
errhandler:
...
Case 0
    oGetbackupDatabase
    MsgBox "Backup Database Selesai ", vbInformation
