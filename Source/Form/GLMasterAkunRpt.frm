...
Begin VB.Form GLMasterAkunRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Daftar Akun Report "
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLMasterAkunRpt.frx":0000
      End
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         Height          =   285
         Index           =   1
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLMasterAkunRpt.frx":001C
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterAkunRpt.frx":0038
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterAkunRpt.frx":0054
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnGLMasterAkunRpt
End Sub
...
skodefr = IIf(Text1(0) = "", oFindByQuery("select min(coa) from tblglmas", DBaseConection.Modul), Text1(0))
skodeto = IIf(Text1(1) = "", oFindByQuery("select max(coa) from tblglmas", DBaseConection.Modul), Text1(1))
