...
Begin VB.Form PelajaranLevelDetailGroupFrm 
   BackColor       =   &H8000000A&
   ClientHeight    =   8280
   ClientLeft      =   -135
   ClientTop       =   645
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "PelajaranLevelDetailGroupFrm.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "PelajaranLevelDetailGroupFrm.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VSFlex8LCtl.VSFlexGrid oGrid 
      ...
      FormatString    =   $"PelajaranLevelDetailGroupFrm.frx":0038
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "PelajaranLevelDetailGroupFrm"
...
On Error GoTo errhandler
    ...
    If Not oRs.EOF Then
        showData
'              istatus = Normal
'        MenuFrm.SetToolbarku me , istatus, MenuFrm.sGroupUserID, mnLevelDetail
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    ...
    skodelevel = oRubahKutip(Text1(2).Text)
...
On Error GoTo errhandler
    ...
    sQuery = "SELECT kodelevelno,namalevelno,nolvlmulai,nolvlselesai FROM master_pelajaran_level_detail  "
...
With ogrid
    For irow = 1 To .Rows - 1
        skodelevelno = oRubahKutip(.TextMatrix(irow, 0))
        snamalevelno = oRubahKutip(.TextMatrix(irow, 1))
        snolvlmulai = oRubahKutip(.TextMatrix(irow, 2))
        snolvlselesai = oRubahKutip(.TextMatrix(irow, 3))
        Select Case .TextMatrix(irow, .Cols - 1)
        Case Is = 1  'Insert
                    sQuery = "insert into master_pelajaran_level_detail "
                    sQuery = sQuery & "("
                    ...
                    oCon.Execute sQuery
        Case Is = 2 'Update
                    sQuery = "Update master_pelajaran_level_detail "
                    ...
                    oCon.Execute sQuery
        Case Is = 3 'Delete
                    sQuery = "Delete From master_pelajaran_level_detail "
                    sQuery = sQuery & " where kodelevelno='" & skodelevelno & "' and kodelevel='" & skodelevel & "' and kodegroup='" & skodegroup & "'"
                    oCon.Execute sQuery
        End Select
    Next
