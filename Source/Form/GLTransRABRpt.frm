...
Begin VB.Form GLTransRABRpt 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLTransRABRpt.frx":0000
      End
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         Height          =   285
         Index           =   1
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLTransRABRpt.frx":001C
      End
      Begin VB.Label Label1 
         Caption         =   "Bulan"
         Height          =   315
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLTransRABRpt.frx":0038
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLTransRABRpt.frx":0054
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "GLTransRABRpt"
...
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnTransaksiRABFormRpt
End Sub
...
sQuery = "   SELECT tanggal,yop,mop,noslip,a.referensi,a.keterangan,jumlahentri,jumlahtotal,a.closed,    "
sQuery = sQuery & " linenum,b.kd_rab,c.nm_rab,jumlah,coa_debet,coa_kredit,b.referensi referensi2,b.keterangan keterangan2,CONCAT(yop,'-',mop) AS txtperiode "
sQuery = sQuery & " FROM trnent_rab a INNER JOIN trnent_rabdetail1 b ON a.docentry=b.docentry   "
sQuery = sQuery & " INNER JOIN tblrab c ON b.kd_rab=c.kd_rab " & sKriteria
With arGLTransRAB
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Transaksi RAB"
    .lblPeriode.Caption = "No.RAB : " & skodefr & " s/d  " & skodeto
