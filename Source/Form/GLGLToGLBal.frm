...
Begin VB.Form GLGLToGLBal 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLGLToGLBal.frx":0000
      ...
      Begin VSFlex8LCtl.VSFlexGrid oGrid1 
         ...
         FormatString    =   $"GLGLToGLBal.frx":001C
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
On Error GoTo errhandler
    ...
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnPostingGL
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    ...
    sQuery = "call spget_trnent_gl_to_glbal_view"
...
Dim oKon As New ADODB.Connection
    ...
    Next
    End With
    sQuery = "call spprocess_postinggl('" & MenuFrm.sUserID & "')"
    oKon.Execute (sQuery)
    oKon.Close
    Exit Sub
errhandler:
