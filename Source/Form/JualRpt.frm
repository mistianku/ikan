...
Begin VB.Form JualRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Penjualan Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
...
sTitle = "Penjualan Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnJualRpt
End Sub
...
Dim ssortby, ssortby1 As Integer
...
ssortby1 = IIf(Option1(0).value = True, 1, 2)
