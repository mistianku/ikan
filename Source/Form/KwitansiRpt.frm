...
Begin VB.Form KwitansiRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Kwitansi Report"
   ClientHeight    =   7905
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KwitansiRpt.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KwitansiRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
srekap = IIf(Option2(0).value = True, 1, 0)
If Text1(0).text = "" Then
    snoidsiswafr = oFindByQuery("select nodokumen from transaksi_kwitansi order by nodokumen asc limit 1 ", DBaseConection.Modul)
Else
    snoidsiswafr = Text1(0).text
End If
If Text1(2).text = "" Then
    snoidsiswato = oFindByQuery("select nodokumen from transaksi_kwitansi order by nodokumen desc limit 1 ", DBaseConection.Modul)
Else
    snoidsiswato = Text1(2).text
End If
sdokstatus = IIf(Option1(2).value = True, "0", IIf(Option1(3).value = True, "1", "2"))
Dim txtmessage As String
txtmessage = "Tidak Ada Data Sesuai dengan Kriteria Yang Dipilih !! "

If srekap = 1 Then

sQuery = "call sp_transaksi_kwitansi_rekap_rpt('"
...
If oFindByQuery(sQuery & "1)", DBaseConection.Modul) = 0 Then
    ...
    Exit Sub
End If
With arKwitansiRekapRpt
    .lblHeaderTrx = "Bukti Penerimaan Pembayaran Report"
    Select Case sdokstatus
    Case "0"
        .lblStatus = "Status Dokumen " & "Sudah Cair"
    Case "1"
        .lblStatus = "Status Dokumen " & "Belum Cair"
    Case "2"
        .lblStatus = "Semua Status Dokumen "
    End Select
...
sQuery = "call sp_transaksi_kwitansi_rpt('"
sQuery = sQuery & stglfr & "','"
sQuery = sQuery & stglto & "','"
sQuery = sQuery & Text1(0) & "','"
sQuery = sQuery & Text1(2) & "','"
