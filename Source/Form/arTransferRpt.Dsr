VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTransferRpt 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arTransferRpt.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arTransferRpt.dsx":628A
End
Attribute VB_Name = "arTransferRpt"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arTransferRpt.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arTransferRpt.adoKu.Recordset.Fields("Address1").value
lblKota = arTransferRpt.adoKu.Recordset.Fields("City").value
lblFax = arTransferRpt.adoKu.Recordset.Fields("Faximale").value & " " & arTransferRpt.adoKu.Recordset.Fields("Phone1").value
...
With arTransferRpt.adoKu.Recordset
...
'   If .Fields("keysortby").value = 1 Then
        lblheader = "Tanggal  : " & Format(arTransferRpt.adoKu.Recordset.Fields("tgldokumen").value, "dd-mm-yyyy")
'   Else
