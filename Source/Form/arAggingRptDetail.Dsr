VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arAggingRptDetail 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arAggingRptDetail.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arAggingRptDetail.dsx":628A
End
Attribute VB_Name = "arAggingRptDetail"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arAggingRptDetail.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arAggingRptDetail.adoKu.Recordset.Fields("Address1").value
lblKota = arAggingRptDetail.adoKu.Recordset.Fields("City").value
lblFax = arAggingRptDetail.adoKu.Recordset.Fields("Faximale").value & " " & arAggingRptDetail.adoKu.Recordset.Fields("Phone1").value
...
With arAggingRptDetail.adoKu.Recordset
