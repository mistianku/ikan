VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arBeliRptbyPoduk 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arBeliRptbyPoduk.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arBeliRptbyPoduk.dsx":628A
End
Attribute VB_Name = "arBeliRptbyPoduk"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arBeliRptbyPoduk.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arBeliRptbyPoduk.adoKu.Recordset.Fields("Address1").value
lblKota = arBeliRptbyPoduk.adoKu.Recordset.Fields("City").value
lblFax = arBeliRptbyPoduk.adoKu.Recordset.Fields("Faximale").value & " " & arBeliRptbyPoduk.adoKu.Recordset.Fields("Phone1").value
...
With arBeliRptbyPoduk.adoKu.Recordset
...
'        arBeliRptbyPoduk.GroupHeader1.Visible = False
