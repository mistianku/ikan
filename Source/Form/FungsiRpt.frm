...
Begin VB.Form FungsiRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Fungsi Produk Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
...
sTitle = "Master Fungsi Produk Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnFungsiRpt
...
skodebrandfr = IIf(Text1(0) = "", oFindByQuery("select kodefungsi from master_fungsi order by kodefungsi asc limit 1", DBaseConection.Modul), Text1(0))
skodebrandto = IIf(Text1(1) = "", oFindByQuery("select kodefungsi from master_fungsi order by kodefungsi desc limit 1", DBaseConection.Modul), Text1(1))

Dim sKriteria As String

sKriteria = " where kodefungsi  between '" & skodebrandfr & "' and '" & skodebrandto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    master_fungsi master_fungsi1" & sKriteria
With arSatuanProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Fungsi Produk"
    .lblPeriode.Caption = "Kode Fungsi Produk : " & skodebrandfr & " s/d  " & skodebrandto
    ...
    .txtkode.DataField = "kodefungsi"
    .txtketerangan.DataField = "namafungsi"
