...
Begin VB.Form AreaRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Diskon Produk Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
...
sTitle = "Master Area Produk Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnAreaRpt
End Sub
...
skodebrandfr = IIf(Text1(0) = "", oFindByQuery("select kodeArea from master_Area order by kodeArea asc limit 1", DBaseConection.Modul), Text1(0))
skodebrandto = IIf(Text1(1) = "", oFindByQuery("select kodeArea from master_Area order by kodeArea desc limit 1", DBaseConection.Modul), Text1(1))

Dim sKriteria As String

sKriteria = " where kodeArea  between '" & skodebrandfr & "' and '" & skodebrandto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    master_Area master_Area1" & sKriteria
sQuery = sQuery & "    order by visorder asc"
With arMasterDiskonProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Area Produk"
    .lblPeriode.Caption = "Kode Area Produk : " & skodebrandfr & " s/d  " & skodebrandto
    ...
    .adoKu.Source = sQuery
    .lblKode = "Kode Area"
    .lblketerangan = "Nama Area"
    .txtkode.DataField = "kodeArea"
    .txtketerangan.DataField = "namaarea"
    
    .lbloption1 = "Urutan Tampil"
    .lbloption2 = ""
    .txtoption1.DataField = "visorder"
    .txtoption2.text = ""
