...
Begin VB.Form DaftarHasilTPPRfrsh 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "DaftarHasilTPPRfrsh.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "DaftarHasilTPPRfrsh.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "DaftarHasilTPPRfrsh"
...
sTitle = "Daftar Siswa Keluar Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnDaftarHasilTPP
End Sub
...
Me.cr1.ReportFileName = App.Path + "\Reports\DaftarHasilTPP.Rpt"

Dim sKriteria As String
sKriteria = " Where tgltest between '" & stglfr & "' and '" & stglto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    vmaster_hasil_tpp_rpt vmaster_hasil_tpp_rpt1 " & sKriteria & " "
'
'
...
Me.cr1.ParameterFields(4) = "tglfr" & ";" & Format(FlatDatePicker1(0).value, "DD-MM-YYYY") & ";" & True
Me.cr1.ParameterFields(5) = "tglto" & ";" & Format(FlatDatePicker1(1).value, "DD-MM-YYYY") & ";" & True
