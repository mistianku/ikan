...
sTitle = "Master Diskon Produk Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnDiskonRpt
End Sub
...
skodebrandfr = IIf(Text1(0) = "", oFindByQuery("select kodediskon from master_diskon order by kodediskon asc limit 1", DBaseConection.Modul), Text1(0))
skodebrandto = IIf(Text1(1) = "", oFindByQuery("select kodediskon from master_diskon order by kodediskon desc limit 1", DBaseConection.Modul), Text1(1))

Dim sKriteria As String

sKriteria = " where kodediskon  between '" & skodebrandfr & "' and '" & skodebrandto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    master_diskon master_diskon1" & sKriteria
With arMasterDiskonProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Diskon Produk"
    .lblPeriode.Caption = "Kode Diskon Produk : " & skodebrandfr & " s/d  " & skodebrandto
    ...
    .txtkode.DataField = "kodediskon"
    .txtketerangan.DataField = "keterangan"
    
    .lbloption1 = "Diskon"
    .lbloption2 = ""
    .txtoption1.DataField = "diskon"
    .txtoption2.text = ""
