...
Begin VB.Form KolektorRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Kolektor Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KolektorRpt.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KolektorRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
sTitle = "Master Kolektor Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnKolektorRpt
End Sub
...
Dim skodekolektorfr As String
Dim skodekolektorto As String

skodekolektorfr = IIf(Text1(0) = "", oFindByQuery("select kodekolektor from master_kolektor order by kodekolektor asc limit 1", DBaseConection.Modul), Text1(0))
skodekolektorto = IIf(Text1(1) = "", oFindByQuery("select kodekolektor from master_kolektor order by kodekolektor desc limit 1", DBaseConection.Modul), Text1(1))

Dim sKriteria As String

sKriteria = " where kodekolektor  between '" & skodekolektorfr & "' and '" & skodekolektorto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    master_kolektor master_kolektor1" & sKriteria
With arSatuanProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Kolektor"
    .lblPeriode.Caption = "Kode Kolektor : " & skodekolektorfr & " s/d  " & skodekolektorto
    .lblPeriode2.Visible = False

    .adoKu.Provider = "MSDASQL.1"
    .adoKu.ConnectionString = MainModule.Conectionku(DBaseConection.Modul)
    .adoKu.Source = sQuery
    .lblKode = "Kode Kolektor"
    .lblketerangan = "Nama Kolektor"
    .txtkode.DataField = "kodekolektor"
    .txtketerangan.DataField = "namakolektor"
