...
Begin VB.Form KelasRptRfrsh 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KelasRptRfrsh.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KelasRptRfrsh.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "KelasRptRfrsh"
...
sTitle = "Daftar Kelas Report "
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnKelasReport
End Sub
...
Me.CR1.ReportFileName = App.Path + "\Reports\KelasRpt.Rpt"
...
sKriteria = sKriteria & " and noidsiswa between '" & snoidsiswafr & "' and '" & snoidsiswato & "' and tglmulai between '" & stglfr & "' and '" & stglto & "'"
...
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    vmaster_kelas_rpt vmaster_kelas_rpt1 " & sKriteria & " "
'
'
