VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arMasukLainFrm 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arMasukLainFrm.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arMasukLainFrm.dsx":628A
End
Attribute VB_Name = "arMasukLainFrm"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arMasukLainFrm.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arMasukLainFrm.adoKu.Recordset.Fields("Address1").value
lblKota = arMasukLainFrm.adoKu.Recordset.Fields("City").value
lblFax = arMasukLainFrm.adoKu.Recordset.Fields("Faximale").value & " " & arMasukLainFrm.adoKu.Recordset.Fields("Phone1").value
...
With arMasukLainFrm.adoKu.Recordset
