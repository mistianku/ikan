VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arMasukLainRpt 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arMasukLainRpt.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arMasukLainRpt.dsx":628A
End
Attribute VB_Name = "arMasukLainRpt"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arMasukLainRpt.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arMasukLainRpt.adoKu.Recordset.Fields("Address1").value
lblKota = arMasukLainRpt.adoKu.Recordset.Fields("City").value
lblFax = arMasukLainRpt.adoKu.Recordset.Fields("Faximale").value & " " & arMasukLainRpt.adoKu.Recordset.Fields("Phone1").value
...
With arMasukLainRpt.adoKu.Recordset
...
With arMasukLainRpt.adoKu.Recordset
   ...
   If .Fields("keysortby").value = 1 Then
        lblheader = "Tanggal  : " & Format(arMasukLainRpt.adoKu.Recordset.Fields("tgldokumen").value, "dd-mm-yyyy")
   Else
