...
Begin VB.Form GLRabToGL 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid oGrid1 
         ...
         FormatString    =   $"GLRabToGL.frx":001C
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
...
On Error GoTo errhandler
    ...
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnTransferRABkeGL
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    ...
    sQuery = "call spget_trnent_rab_to_gl_view"
    ...
    With oGrid1
        ...
        If Not oRsDetail.EOF Then
            ...
            Do While Not oRsDetail.EOF
                ...
                .TextMatrix(i, 3) = RTrim(oRsDetail("txtjnsbayar"))
                .TextMatrix(i, 4) = RTrim(oRsDetail("jmldok"))
                .TextMatrix(i, 5) = RTrim(oRsDetail("ttlvalue"))
...
Dim oKon As New ADODB.Connection
    ...
    Dim irow As Integer
    For irow = 1 To .Rows - 1
            If .TextMatrix(irow, 0) = -1 And .TextMatrix(irow, .Cols - 1) = "N" Then
                ...
                sQuery = sQuery & GetDocnum(transaksi_trngl, True, parkir) & "')"
                'GetDocnum(transaksi_trngl, True, parkir)
                oKon.Execute (sQuery)
    ...
    Next
    End With
    sQuery = "call sp_proses_rab_to_gl('" & Format(Now(), "YYYY-MM-DD") & "','" & "" & "','" & MenuFrm.sUserID & "')"
    oKon.Execute (sQuery)
    oKon.Close
    Exit Sub
errhandler:
