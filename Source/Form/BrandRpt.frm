...
Begin VB.Form BrandRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Brand Produk Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
...
sTitle = "Master Brand Produk Report"
...
oInsertModulMenu Me.Name, Me.Caption, typemenu.report, MenuFrm.sinsertmodul
...
skodebrandfr = IIf(Text1(0) = "", oFindByQuery("select kodebrand from master_brand order by kodebrand asc limit 1", DBaseConection.Modul), Text1(0))
skodebrandto = IIf(Text1(1) = "", oFindByQuery("select kodebrand from master_brand order by kodebrand desc limit 1", DBaseConection.Modul), Text1(1))

Dim sKriteria As String

sKriteria = " where kodebrand  between '" & skodebrandfr & "' and '" & skodebrandto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    master_brand master_brand1" & sKriteria
With arSatuanProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Brand Produk"
    .lblPeriode.Caption = "Kode Brand Produk : " & skodebrandfr & " s/d  " & skodebrandto
    ...
    .txtkode.DataField = "kodebrand"
    .txtketerangan.DataField = "namabrand"
