VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arAggingRptRekap 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arAggingRptRekap.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arAggingRptRekap.dsx":628A
End
Attribute VB_Name = "arAggingRptRekap"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arAggingRptRekap.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arAggingRptRekap.adoKu.Recordset.Fields("Address1").value
lblKota = arAggingRptRekap.adoKu.Recordset.Fields("City").value
lblFax = arAggingRptRekap.adoKu.Recordset.Fields("Faximale").value & " " & arAggingRptRekap.adoKu.Recordset.Fields("Phone1").value
...
With arAggingRptRekap.adoKu.Recordset
