...
Begin VB.Form GLMasterEntriDataRpt 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterEntriDataRpt.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterEntriDataRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLMasterEntriDataRpt.frx":0038
      End
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         Height          =   285
         Index           =   1
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLMasterEntriDataRpt.frx":0054
      End
      Begin VB.Label Label1 
         Caption         =   "Bulan"
         Height          =   315
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterEntriDataRpt.frx":0070
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterEntriDataRpt.frx":008C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "GLMasterEntriDataRpt"
...
Dim skodefr1 As String
Dim skodeto1 As String
...
Case 2
    ...
    oBrowse.ShowFinder BrowsAkunSumberData, ""
    If Not oBrowse.YangDipilih = "" Then
...
sTitle = "Master Data Entri Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnMasterDataEntriRpt
End Sub
...
skodefr = IIf(Text1(0) = "", oFindByQuery("select min(gr_dataentry) from tblgrupdataentry", parkir), Text1(0))
skodeto = IIf(Text1(1) = "", oFindByQuery("select max(gr_dataentry) from tblgrupdataentry", parkir), Text1(1))
skodefr1 = IIf(Text1(4) = "", oFindByQuery("select min(kd_dataentry) from tblglsbrdata", parkir), Text1(4))
skodeto1 = IIf(Text1(5) = "", oFindByQuery("select max(kd_dataentry) from tblglsbrdata", parkir), Text1(5))
sstatus = IIf(Option1(0).value = True, "Status='Y'", IIf(Option1(1).value = True, "Status='N'", "true"))
sKriteria = " where a.gr_dataentry between '" & skodefr & "'  and '" & skodeto & "' "
sKriteria = sKriteria & " and a.kd_dataentry between '" & skodefr1 & "'  and '" & skodeto1 & "' "
sQuery = "SELECT  kd_dataentry,nm_dataentry,dayseqno,coa_debet,coa_kredit,a.gr_dataentry, "
sQuery = sQuery & "b1.nm_akun AS nm_akundbt,b2.nm_akun AS nm_akuncrt,c.nm_grupdata "
sQuery = sQuery & "FROM tblglsbrdata a  "
sQuery = sQuery & "INNER JOIN tblglmas b1 ON a.coa_debet=b1.coa "
sQuery = sQuery & "INNER JOIN tblglmas b2 ON a.coa_kredit=b2.coa "
sQuery = sQuery & "LEFT JOIN tblgrupdataentry c ON a.gr_dataentry=c.gr_dataentry " & sKriteria
With arGLMasterEntriData
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Data Entri"
    .lblPeriode.Caption = "Kode Group Entri : " & skodefr & " s/d  " & skodeto
    '.lblPeriode2.Visible = False
    .lblPeriode2.Caption = "Kode Data Entri : " & skodefr1 & " s/d  " & skodeto1
