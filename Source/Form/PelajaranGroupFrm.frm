...
Begin VB.Form PelajaranGroupFrm 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "PelajaranGroupFrm.frx":0000
   ...
   End
End
Attribute VB_Name = "PelajaranGroupFrm"
...
On Error GoTo errhandler
    skodegroup = ToText(Text1(0).Text)
    snamagroup = Replace(ToText(Text1(1).Text), "'", "\'")
