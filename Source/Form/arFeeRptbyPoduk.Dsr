VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arFeeRptbyPoduk 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arFeeRptbyPoduk.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arFeeRptbyPoduk.dsx":628A
End
Attribute VB_Name = "arFeeRptbyPoduk"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arFeeRptbyPoduk.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arFeeRptbyPoduk.adoKu.Recordset.Fields("Address1").value
lblKota = arFeeRptbyPoduk.adoKu.Recordset.Fields("City").value
lblFax = arFeeRptbyPoduk.adoKu.Recordset.Fields("Faximale").value & " " & arFeeRptbyPoduk.adoKu.Recordset.Fields("Phone1").value
...
With arFeeRptbyPoduk.adoKu.Recordset
