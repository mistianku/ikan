VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTransferFrm 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arTransferFrm.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arTransferFrm.dsx":628A
End
Attribute VB_Name = "arTransferFrm"
...
lblCompany1.Caption = arTransferFrm.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arTransferFrm.adoKu.Recordset.Fields("Address1").value
lblKota = arTransferFrm.adoKu.Recordset.Fields("City").value
lblFax = arTransferFrm.adoKu.Recordset.Fields("Faximale").value & " " & arTransferFrm.adoKu.Recordset.Fields("Phone1").value
...
With arTransferFrm.adoKu.Recordset
