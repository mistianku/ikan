VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arJualRpt 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arJualRpt.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arJualRpt.dsx":628A
End
Attribute VB_Name = "arJualRpt"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arJualRpt.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arJualRpt.adoKu.Recordset.Fields("Address1").value
lblKota = arJualRpt.adoKu.Recordset.Fields("City").value
lblFax = arJualRpt.adoKu.Recordset.Fields("Faximale").value & " " & arJualRpt.adoKu.Recordset.Fields("Phone1").value
...
With arJualRpt.adoKu.Recordset
...
Label37.Caption = "Sub Total " & arJualRpt.Field15.text
End Sub
...
'        arJualRpt.GroupHeader1.Visible = False
'        arJualRpt.GroupFooter1.Visible = False
'   End If
