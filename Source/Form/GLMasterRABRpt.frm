...
Begin VB.Form GLMasterRABRpt 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLMasterRABRpt.frx":0000
      End
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         Height          =   285
         Index           =   1
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "GLMasterRABRpt.frx":001C
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterRABRpt.frx":0038
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "GLMasterRABRpt.frx":0054
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "GLMasterRABRpt"
...
sTitle = "Master RAB Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnMaterRABRpt
End Sub
...
skodefr = IIf(Text1(0) = "", oFindByQuery("select min(kd_rab) from tblrab", parkir), Text1(0))
skodeto = IIf(Text1(1) = "", oFindByQuery("select max(kd_rab) from tblrab", parkir), Text1(1))
sstatus = IIf(Option1(0).value = True, "Aktif='Y'", IIf(Option1(1).value = True, "Aktif='N'", "true"))
sKriteria = " where a.kd_rab between '" & skodefr & "'  and '" & skodeto & "' and " & sstatus
sQuery = "SELECT kd_rab,nm_rab,rab_debet, b1.nm_akun rab_debetket,"
sQuery = sQuery & "rab_kredit, b2.nm_akun rab_kreditket,aktif "
sQuery = sQuery & "FROM tblrab a "
sQuery = sQuery & "INNER JOIN tblglmas b1 ON a.rab_debet = b1.coa "
sQuery = sQuery & "INNER JOIN tblglmas b2 ON a.rab_debet = b2.coa " & sKriteria
With arGLMasterRAB
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master RAB "
    .lblPeriode.Caption = "Kode RAB : " & skodefr & " s/d  " & skodeto
