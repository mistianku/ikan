VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arGLMasterEntriData 
   Caption         =   "Kwitansi"
   ClientHeight    =   10950
   ClientLeft      =   225
   ClientTop       =   555
   ...
   _ExtentX        =   35719
   _ExtentY        =   19315
   SectionData     =   "arGLMasterEntriData.dsx":0000
End
Attribute VB_Name = "arGLMasterEntriData"
...
With arGLTrailBalance.adoKu.Recordset
...
'lblGroupData.Caption = arGLTrailBalance.adoKu.Recordset.Fields("gr_dataentry").value
End Sub
