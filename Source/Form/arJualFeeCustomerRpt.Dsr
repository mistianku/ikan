VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arJualFeeCustomerRpt 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arJualFeeCustomerRpt.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arJualFeeCustomerRpt.dsx":628A
End
Attribute VB_Name = "arJualFeeCustomerRpt"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arJualFeeCustomerRpt.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arJualFeeCustomerRpt.adoKu.Recordset.Fields("Address1").value
lblKota = arJualFeeCustomerRpt.adoKu.Recordset.Fields("City").value
lblFax = arJualFeeCustomerRpt.adoKu.Recordset.Fields("Faximale").value & " " & arJualFeeCustomerRpt.adoKu.Recordset.Fields("Phone1").value
...
With arJualFeeCustomerRpt.adoKu.Recordset
...
With arJualFeeCustomerRpt.adoKu.Recordset
   ...
   If .Fields("keysortby").value = 1 Then
        arJualFeeCustomerRpt.GroupHeader1.Visible = False
        arJualFeeCustomerRpt.GroupFooter1.Visible = False
   End If
