...
Begin VB.Form LhppForm 
   BackColor       =   &H8000000A&
   Caption         =   "Penerbitan LHPP Form"
   ClientHeight    =   8100
   ClientLeft      =   -135
   ClientTop       =   975
   ClientWidth     =   12195
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid 
         ...
         FormatString    =   $"LhppFrom.frx":C882
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":CA2D
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":CD47
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":D061
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":D37B
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":D4D5
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":D62F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":D789
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":D8E3
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":DA3D
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":DB97
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":DCF1
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":DE4B
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":DFA5
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":E0FF
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":E259
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":E3B3
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":E50D
            Key             =   ""
         EndProperty
         BeginProperty ListImage18 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":E667
            Key             =   ""
         EndProperty
         BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "LhppFrom.frx":E7C1
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Dim iNilLHHPnotCurrentEntryAwal, iNilLHHPnotCurrentEntry As Double
...
On Error GoTo errhandler
    ...
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnLhppForm
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "call sp_transaksi_lhpp_get('" & Text1(0).text & "',1)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
    oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "call sp_transaksi_lhpp_get('" & Text1(0).text & "',3)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "call sp_transaksi_lhpp_get('" & Text1(0).text & "',2)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "call sp_transaksi_lhpp_get('" & Text1(0).text & "',4)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    Else
...
On Error GoTo errhandler
    If setData Then
        ...
        If ogrid.Rows = 1 Then
            MsgBox "Tidak Ada Data Yang dientry ", vbInformation, "Entry Data Detail"
        Else
...
On Error GoTo errhandler
    ...
    If istatus = StatusForm.DataBaru Then
        snodokumen = IIf(Text1(0).text = "", GetDocnum(transaksi_lhpp, True, DBaseConection.Modul), Text1(0).text)
    ...
    sQuery = "call sp_transaksi_lhpp_update('" & sbatchid & "','"
...
Select Case Index
Case 0
oBrowse.ShowFinder Browslhpp, "", ubDescending, DBaseConection.Modul
...
Select Case Index
Case 12
    Text1(11) = ToNumber(Text1(Index))
    Text1(10) = Format(ToNumber(oFindByQuery("SELECT totnillhpp FROM transaksi_lhpp WHERE batchid=" & sbatchid, DBaseConection.Modul)), "###,###,###.#0")
...
On Error GoTo errhandler
    ...
    sQuery = "CALL sp_transaksi_lhpp_detail2_get('" & sbatchid & "','"
    ...
    oKon.Close
    oRecalculate
iNilLHHPnotCurrentEntryAwal = ToNumber(Text1(7))
Text1(12) = sdocentry
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    ...
    With ogrid
            ...
            For i = 1 To .Rows - 1
                ...
                sQuery = "Call sp_transaksi_lhpp_detail2_insert('" & sbatchid & "','"
                sQuery = sQuery & sdocentry & "','"
...
Case 9
    ...
    Dim oBrowse As New BrowseFrm
    oBrowse.ShowFinder Browslhppdetail1, "batchid=" & sbatchid, ubAscending, DBaseConection.Modul
    If Not oBrowse.YangDipilih = "" Then oShowEntry sbatchid, oBrowse.YangDipilih, 0
    Set oBrowse = Nothing

End Select
If istatus = StatusForm.NormalClosePlusExec Then
...
On Error GoTo errhandler
    ...
    Dim sKondisi As String
    sQuery = "sp_transaksi_lhpp_detail1_get(" & sbatchidQ & "," & sdocentryQ & "," & sget & ")"
'    -- iNilLHHPnotCurrentEntry = ToNumber(oFindByQuery("SELECT  SUM(sisanilkwitansi) FROM transaksi_lhpp_detail2 WHERE batchid=" & sbatchid & " AND docentry!=" & sdocentry & "", DBaseConection.Modul))
...
If istatus = False Then
    ...
    For irows = 1 To .Buttons.Count - 5
...
'    stotnilkwitansi = toNumberIndonesia(Text1(7))
    sQuery = "call sp_transaksi_lhpp_detail1_update('"
