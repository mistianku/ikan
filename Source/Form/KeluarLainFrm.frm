...
Begin VB.Form KeluarLainFrm 
   BackColor       =   &H8000000A&
   Caption         =   "Transaksi Keluar Lain Lain Form"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid 
         ...
         FormatString    =   $"KeluarLainFrm.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
         ...
         Begin VSDFLATS.FlatButton BrowseUserID 
            ...
            _ExtentX        =   873
            _ExtentY        =   450
            MouseIcon       =   "KeluarLainFrm.frx":0203
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KeluarLainFrm.frx":021F
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KeluarLainFrm.frx":023B
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KeluarLainFrm.frx":0257
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KeluarLainFrm.frx":0273
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "KeluarLainFrm.frx":028F
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "KeluarLainFrm"
...
On Error GoTo errhandler
    ...
    sQuery = "Select * from vtransaksi_keluar_lain where nodokumen='" & sKodeUserAkses & "'"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnKeluarLainFrm
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select *  from vtransaksi_keluar_lain order by nodokumen asc limit 1"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
    oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select  *  from vtransaksi_keluar_lain where nodokumen >'" & Text1(0).text & "' order by nodokumen asc limit 1"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select  *  from vtransaksi_keluar_lain where nodokumen<'" & Text1(0).text & "' order by nodokumen desc limit 1"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select *  from vtransaksi_keluar_lain order by nodokumen desc limit 1 "
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    Else
...
On Error GoTo errhandler
    If setData Then
        ...
        If istatus = DataBaru Then
            sdocentry = oFindByQuery("select docentry from transaksi_keluar_lain where nodokumen='" & Text1(0) & "'", DBaseConection.Modul)
        End If
        SaveGrid sdocentry
        oCon.Close
        DoSaveData = True
...
On Error GoTo errhandler
    If setData Then
        If oCon.State = 1 Then oCon.Close
         oCon.Open MainModule.Conectionku(DBaseConection.Modul)
        sQuery = "Delete from transaksi_keluar_lain where nodokumen='" & snodokumen & "'"
        oCon.Execute sQuery
        oCon.Close
...
Public Sub NewData()
    If MenuFrm.sAplikasiDemo Then
        If oCekJumlahTrx("transaksi_keluar_lain", MenuFrm.sMaxIsiTable) Then Exit Sub
    End If
...
On Error GoTo errhandler
    ...
    If istatus = StatusForm.DataBaru Then
        snodokumen = IIf(Text1(0).text = "", GetDocnum(transaksi_keluarlain, True, DBaseConection.Modul), Text1(0).text)
...
Select Case Index
Case 0
oBrowse.ShowFinder BrowsKeluarLain, "", ubDescending, DBaseConection.Modul
...
sTitle = "Transaksi Keluar Lain Lain"
...
On Error GoTo errhandler
    ...
    Text1(12) = Format(oRs("totalsebpotongan"), "###,###,###.##")
    Text1(13) = formatRupiah(oRs("totalpotongan"))
    Text1(14) = Format(oRs("totalsetpotongan"), "###,###,###.##")
...
On Error GoTo errhandler
    ...
    sQuery = "SELECT * FROM vtransaksi_keluar_lain_detail1  "
...
On Error GoTo errhandler
    ...
    If oKon.State = 1 Then oKon.Close
    oKon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "SELECT * FROM vmaster_customer  "
    sQuery = sQuery & sKondisi
    ...
    With ogrid
            ...
            For i = 1 To .Rows - 1
                ...
                Case 1 And Not skodeproduk1 = ""
                        sQuery = "insert into transaksi_keluar_lain_detail1 "
                        sQuery = sQuery & "("
                ...
                Case 2
                        ...
                        sQuery = "update  transaksi_keluar_lain_detail1 "
                        sQuery = sQuery & " set "
                ...
                Case 3
                        oKon.Execute "update master_inventori set stock=stock+" & sjumlahseb & " where kodegudang='" & skodegudanglama & "' and kodeproduk='" & skodeproduk1 & "'"
                        oKon.Execute "delete from transaksi_keluar_lain_detail1 where docentry='" & sdocentry & "' and linenum='" & slinenum1 & "'"
                End Select
            Next
...
sQuery = "call sp_transaksi_keluar_lain_form('"
...
If oFindByQuery(sQuery & "1)", DBaseConection.Modul) = 0 Then
    ...
    Exit Sub
End If
With arKeluarLainFrm
    .lblHeaderTrx = "KELUAR LAIN-LAIN"
...
Exit Sub
errhandler:
MainModule.ShowMessage Err.Description, "Transaksi Keluar Lain-lain"
End Sub
