...
Begin VB.Form MonitoringPelunasanFakturRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Monitoring Tukar Faktur Form"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "MonitoringPelunasanFakturRpt.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "MonitoringPelunasanFakturRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "MonitoringPelunasanFakturRpt"
...
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnJualMonitoringFakturRpt
End Sub
...
sstatusdok = IIf(Option1(0).value = True, "0", IIf(Option1(1).value = True, "1", "A"))
...
sQuery = "call sp_transaksi_keluar_lunas_faktur_rpt('"
...
If oFindByQuery(sQuery & "1)", DBaseConection.Modul) = 0 Then
    ...
    Exit Sub
End If
With arJualMonitoringLunasFakturRpt
    .lblHeaderTrx = "Report Monitoring Pelunasan Faktur"
