VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arFeeRptbyPodukRekap 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arFeeRptbyPodukRekap.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arFeeRptbyPodukRekap.dsx":628A
End
Attribute VB_Name = "arFeeRptbyPodukRekap"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arFeeRptbyPodukRekap.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arFeeRptbyPodukRekap.adoKu.Recordset.Fields("Address1").value
lblKota = arFeeRptbyPodukRekap.adoKu.Recordset.Fields("City").value
lblFax = arFeeRptbyPodukRekap.adoKu.Recordset.Fields("Faximale").value & " " & arFeeRptbyPodukRekap.adoKu.Recordset.Fields("Phone1").value
...
With arFeeRptbyPodukRekap.adoKu.Recordset
