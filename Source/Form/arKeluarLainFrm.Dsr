VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arKeluarLainFrm 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arKeluarLainFrm.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arKeluarLainFrm.dsx":628A
End
Attribute VB_Name = "arKeluarLainFrm"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arKeluarLainFrm.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arKeluarLainFrm.adoKu.Recordset.Fields("Address1").value
lblKota = arKeluarLainFrm.adoKu.Recordset.Fields("City").value
lblFax = arKeluarLainFrm.adoKu.Recordset.Fields("Faximale").value & " " & arKeluarLainFrm.adoKu.Recordset.Fields("Phone1").value
...
With arKeluarLainFrm.adoKu.Recordset
