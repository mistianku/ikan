...
Begin VB.Form LabaRugiByCustomerByProductRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Laba Rugi Customer By Product Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "LabaRugiByCustomerByProductRpt.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "LabaRugiByCustomerByProductRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "LabaRugiByCustomerByProductRpt.frx":0038
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "LabaRugiByCustomerByProductRpt.frx":0054
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "LabaRugiByCustomerByProductRpt"
...
If ssortby = 1 Then
    slblHeaderTrx = "Report Laba Rugi By Customer"
...
'    End If
Else
    slblHeaderTrx = "Report Laba Rugi By Produk"
...
If sstssiwa = "Y" Then
        sQuery = "call sp_transaksi_keluar_laba_rugi_by_cust_item_rpt('"
...
Else
        ...
        If oFindByQuery(sQuery & "1)", DBaseConection.Modul) = 0 Then
            MsgBox txtmessage, vbInformation, "Pesan Cetak Report Laba Rugi "
            Exit Sub
        End If
        With arLabaRugiRptbyPodukRekap
            .lblHeaderTrx = slblHeaderTrx
