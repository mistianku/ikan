...
Begin VB.Form TransferFrm 
   BackColor       =   &H8000000A&
   Caption         =   "Transaksi Pindah Antar Gudang Form"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid 
         ...
         FormatString    =   $"TransferFrm.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
         ...
         Begin VSDFLATS.FlatButton BrowseUserID 
            ...
            _ExtentX        =   873
            _ExtentY        =   450
            MouseIcon       =   "TransferFrm.frx":023C
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "TransferFrm.frx":0258
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "TransferFrm.frx":0274
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "TransferFrm.frx":0290
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "TransferFrm.frx":02AC
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "TransferFrm.frx":02C8
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "TransferFrm.frx":02E4
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Dim skodegudangfr As String
Dim skodegudangto As String
...
Dim skodegudang2 As String
Dim skodegudang1lama As String
Dim skodegudang2lama As String
...
On Error GoTo errhandler
    ...
    sQuery = "Select * from vtransaksi_transfer where nodokumen='" & sKodeUserAkses & "'"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnTransferFrm
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select *  from vtransaksi_transfer order by nodokumen asc limit 1"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
    oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select  *  from vtransaksi_transfer where nodokumen >'" & Text1(0).text & "' order by nodokumen asc limit 1"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select  *  from vtransaksi_transfer where nodokumen<'" & Text1(0).text & "' order by nodokumen desc limit 1"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Select *  from vtransaksi_transfer order by nodokumen desc limit 1 "
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    Else
...
On Error GoTo errhandler
    If setData Then
        ...
        If istatus = DataBaru Then
            sdocentry = oFindByQuery("select docentry from transaksi_transfer where nodokumen='" & Text1(0) & "'", DBaseConection.Modul)
        End If
        SaveGrid sdocentry
        oCon.Close
        DoSaveData = True
...
Public Sub NewData()
    If MenuFrm.sAplikasiDemo Then
        If oCekJumlahTrx("transaksi_transfer", MenuFrm.sMaxIsiTable) Then Exit Sub
    End If
...
On Error GoTo errhandler
    ...
    If istatus = StatusForm.DataBaru Then
        snodokumen = IIf(Text1(0).text = "", GetDocnum(transaksi_transfer, True, DBaseConection.Modul), Text1(0).text)
        Text1(0).text = snodokumen
    Else
        snodokumen = Text1(0).text
    End If
    skodesupplier = Text1(1).text
    ...
    skodesupplier = Text1(1)
    skodegudangfr = Text1(4)
    skodegudangto = Text1(15)
    skodediskon = "0" 'Text1(5)
    skodeharga = ToText(Text1(6))
    sketerangan = Text1(10)
    sreferensi = Text1(11)
...
'        stipetransaksi CHAR(1),
'        skodesupplier VARCHAR(15),
'        skodegudangfr VARCHAR(6),
'        skodegudangto VARCHAR(6),
...
'        saudituser VarChar(10)
    ...
    sQuery = "call sp_transaksi_transfer_update('" & sdocentry & "','"
    sQuery = sQuery & snodokumen & "','"
    sQuery = sQuery & Format(stgldokumen, "YYYY-MM-DD") & "','"
    sQuery = sQuery & "" & "','"
    sQuery = sQuery & skodesupplier & "','"
    sQuery = sQuery & skodegudangfr & "','"
    sQuery = sQuery & skodegudangto & "','"
...
Select Case Index
Case 0
oBrowse.ShowFinder BrowsTransfer, "", ubDescending, DBaseConection.Modul
...
sTitle = "Transaksi Pindah Antar Gudang"
...
On Error GoTo errhandler
    ...
    Text1(1) = oRs("kodesupplier")
        Text1(2) = ToText(oRs("namasupplier"))
            Text1(3) = ToText(oRs("alamat"))
    Text1(4) = oRs("kodegudangfr")
    Text1(15) = oRs("kodegudangto")
    Text1(5) = oRs("kodediskon")
    Text1(6) = oRs("kodeharga")

    Text1(7) = oRs("namagudangfr")
        Text1(16) = oRs("namagudangto")
    Text1(8) = ToText(oRs("namadiskon"))
    Text1(9) = ToText(oRs("namaharga"))

    Text1(10) = oRs("keterangan")
    Text1(11) = oRs("referensi")
    Text1(12) = Format(oRs("totalsebpotongan"), "###,###,###.#0")
    Text1(13) = Format(oRs("totalpotongan"), "###,###,###.#0")
    Text1(14) = Format(oRs("totalsetpotongan"), "###,###,###.#0")
...
With ogrid
If .Rows = 1 And (Not Text1(4) = "" And Not Text1(15) = "" And Not Text1(6) = "") Then
    AddRow
End If
End With
End Sub
...
Select Case Index
Case 4
    oUpdateKodeGudangKolom Text1(Index), 8, ogrid
Case 15
    oUpdateKodeGudangKolom Text1(Index), 12, ogrid
End Select
End Sub
...
On Error GoTo errhandler
    ...
    sQuery = "SELECT * FROM vtransaksi_transfer_detail1  "
    ...
    With ogrid
        ...
        If Not oRsDetail.EOF Then
            ...
            Do While Not oRsDetail.EOF
                ...
                .TextMatrix(i, 8) = RTrim(oRsDetail("kodegudangfr"))
                ...
                .TextMatrix(i, 12) = ToText(RTrim(oRsDetail("kodegudangto")))
                .TextMatrix(i, .Cols - 5) = ToText(RTrim(oRsDetail("kodegudangfr")))
                .TextMatrix(i, .Cols - 4) = ToText(RTrim(oRsDetail("kodegudangto")))
...
On Error GoTo errhandler
    ...
    With ogrid
            ...
            For i = 1 To .Rows - 1
                ...
                sQuery = "call sp_transaksi_transfer_detail1_insert('"
                ...
                Case 1 And Not skodeproduk1 = ""
                        oKon.Execute sQuery
                Case 2
                        oKon.Execute Replace(sQuery, "insert", "update")
                Case 3
                        oKon.Execute Replace(sQuery, "insert", "delete")
                End Select
            Next
...
On Error GoTo errhandler
    ...
    With ogrid
            ...
            For i = 1 To .Rows - 1
                ...
                sQuery = "call sp_transaksi_transfer_detail1_delete('"
                sQuery = sQuery & sdocentry & "','"
                sQuery = sQuery & slinenum1 & "','"
                sQuery = sQuery & skodeproduk1 & "','"
                sQuery = sQuery & skodeharga1 & "','"
...
sQuery = "call sp_transaksi_transfer_form('"
...
End If
With arTransferFrm
    .lblHeaderTrx = "Pindah Antar Gudang"
...
Exit Sub
errhandler:
MainModule.ShowMessage Err.Description, "Transaksi Transfer Antar Gudang"
End Sub
