VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arLabaRugiRptbyPodukRekap 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arLabaRugiRptbyPodukRekap.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arLabaRugiRptbyPodukRekap.dsx":628A
End
Attribute VB_Name = "arLabaRugiRptbyPodukRekap"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arLabaRugiRptbyPoduk.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arLabaRugiRptbyPoduk.adoKu.Recordset.Fields("Address1").value
lblKota = arLabaRugiRptbyPoduk.adoKu.Recordset.Fields("City").value
lblFax = arLabaRugiRptbyPoduk.adoKu.Recordset.Fields("Faximale").value & " " & arLabaRugiRptbyPoduk.adoKu.Recordset.Fields("Phone1").value
...
With arLabaRugiRptbyPoduk.adoKu.Recordset
