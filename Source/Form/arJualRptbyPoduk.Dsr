VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arJualRptbyPoduk 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arJualRptbyPoduk.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arJualRptbyPoduk.dsx":628A
End
Attribute VB_Name = "arJualRptbyPoduk"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arJualRptbyPoduk.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arJualRptbyPoduk.adoKu.Recordset.Fields("Address1").value
lblKota = arJualRptbyPoduk.adoKu.Recordset.Fields("City").value
lblFax = arJualRptbyPoduk.adoKu.Recordset.Fields("Faximale").value & " " & arJualRptbyPoduk.adoKu.Recordset.Fields("Phone1").value
...
With arJualRptbyPoduk.adoKu.Recordset
