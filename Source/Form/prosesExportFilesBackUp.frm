...
Begin VB.Form ProsesExportFilesBackup 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "prosesExportFilesBackUp.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "prosesExportFilesBackUp.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ProsesExportFilesBackup"
...
oProsesImport "d:/exportfiles/", "sales"
...
Public Sub oProsesImport(sfolder As String, sfile As String)
On Error GoTo errhandler
Dim i As Integer

' sp_export_file_faktur`(IN sfolder TEXT,sfile TEXT)

        If oCon.State = 1 Then oCon.Close
        oCon.Open MainModule.Conectionku(DBaseConection.Modul)
        sQuery = "call sp_export_file_faktur('" & sfolder & "','" & sfile & "')"
