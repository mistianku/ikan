...
Begin VB.Form MonitoringTukarFaktur 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton FlatButton1 
         ...
         _ExtentX        =   3413
         _ExtentY        =   661
         MouseIcon       =   "MonitoringTukarFaktur.frx":0000
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid oGrid1 
         ...
         FormatString    =   $"MonitoringTukarFaktur.frx":001C
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "MonitoringTukarFaktur.frx":0195
      End
   ...
   End
End
Attribute VB_Name = "MonitoringTukarFaktur"
...
'skeytgl INT ,stgl DATE
    ...
    sQuery = "CALL sp_transaksi_keluar_tfaktur_get('"
...
On Error GoTo errhandler
    ...
    With oGrid1(0)
        For irow = 1 To .Rows - 1
            ...
            sQuery = sQuery & Format(stgljtfaktur, "YYYY-MM-DD") & "')"
