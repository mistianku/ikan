VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arGLMasterGroupData 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arGLMasterGroupData.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arGLMasterGroupData.dsx":628A
End
Attribute VB_Name = "arGLMasterGroupData"
...
With arGLMasterGroupData.adoKu.Recordset
