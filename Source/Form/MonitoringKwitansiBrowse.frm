...
Begin VB.Form MonitoringKwitansiBrowse 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton FlatButton1 
         ...
         _ExtentX        =   3413
         _ExtentY        =   661
         MouseIcon       =   "MonitoringKwitansiBrowse.frx":0000
      ...
      Begin VSDFLATS.FlatButton FlatButton1 
         ...
         _ExtentX        =   3413
         _ExtentY        =   661
         MouseIcon       =   "MonitoringKwitansiBrowse.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton FlatButton1 
         ...
         _ExtentX        =   3413
         _ExtentY        =   661
         MouseIcon       =   "MonitoringKwitansiBrowse.frx":0038
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid oGrid1 
         ...
         FormatString    =   $"MonitoringKwitansiBrowse.frx":0054
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatComboBox FlatComboBox1 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "MonitoringKwitansiBrowse.frx":01CD
         Enabled         =   0   'False
      End
   ...
   End
End
Attribute VB_Name = "MonitoringKwitansiBrowse"
...
'skeytgl INT ,stgl DATE
    ...
    sQuery = "CALL sp_transaksi_kwitansi_get_lhpp('"
