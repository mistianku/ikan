...
Begin VB.Form SatuanProdukRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Satuan Produk Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "SatuanProdukRpt.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "SatuanProdukRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "SatuanProdukRpt"
...
sTitle = "Master Satuan Produk Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnSatuanProdukRpt
End Sub
...
skodefr = IIf(Text1(0) = "", oFindByQuery("select min(kodesatuan) from master_satuan_produk", DBaseConection.Modul), Text1(0))
skodeto = IIf(Text1(1) = "", oFindByQuery("select max(kodesatuan) from master_satuan_produk", DBaseConection.Modul), Text1(1))

sKriteria = " where kodesatuan between '" & skodefr & "'  and '" & skodeto & "' "
sQuery = "SELECT  kodesatuan, namasatuan FROM master_satuan_produk  " & sKriteria
With arSatuanProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Satuan Produk"
    .lblPeriode.Caption = "Kode Satuan Produk : " & skodefr & " s/d  " & skodeto
