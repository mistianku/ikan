...
Begin VB.Form BeliRptByProduk 
   BackColor       =   &H8000000A&
   Caption         =   "Pembelian By Produk Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "BeliRptByProduk.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "BeliRptByProduk.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "BeliRptByProduk.frx":0038
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "BeliRptByProduk.frx":0054
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "BeliRptByProduk"
...
sTitle = "Pembelian By Produk Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnBeliRptByProduk
End Sub
...
If Text1(0).text = "" Then
    snoidsiswafr = oFindByQuery("select nodokumen from transaksi_masuk order by nodokumen asc limit 1 ", DBaseConection.Modul)
Else
    snoidsiswafr = Text1(0).text
End If
If Text1(2).text = "" Then
    snoidsiswato = oFindByQuery("select nodokumen from transaksi_masuk order by nodokumen desc limit 1 ", DBaseConection.Modul)
Else
    snoidsiswato = Text1(2).text
End If

If ssortby = 1 Then
    slblHeaderTrx = "Report Penbelian By Supplier"
    arBeliRptbyPoduk.Label25.Caption = "Produk"
    If (Text1(0) = Text1(2)) And Not (Text1(0) = "" Or Text1(2) = "") Then
        arBeliRptbyPoduk.GroupFooter1.Visible = False
    End If
Else
    slblHeaderTrx = "Report Penbelian By Produk"
    arBeliRptbyPoduk.Label25.Caption = "Supplier"
...
sQuery = "call sp_transaksi_masuk_by_item_rpt('"
...
'sp_transaksi_masuk_rpt`(IN stglfr DATE ,stglto DATE ,
