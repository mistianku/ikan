...
Begin VB.Form SupplierFrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   503
         MouseIcon       =   "SupplierFrm.frx":0000
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VSDFLATS.FlatButton BrowseUserID 
            ...
            _ExtentX        =   873
            _ExtentY        =   503
            MouseIcon       =   "SupplierFrm.frx":001C
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VSDFLATS.FlatButton BrowseUserID 
            ...
            _ExtentX        =   873
            _ExtentY        =   503
            MouseIcon       =   "SupplierFrm.frx":0038
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VSDFLATS.FlatButton BrowseUserID 
            ...
            _ExtentX        =   873
            _ExtentY        =   503
            MouseIcon       =   "SupplierFrm.frx":0054
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VSDFLATS.FlatButton BrowseUserID 
            ...
            _ExtentX        =   873
            _ExtentY        =   503
            MouseIcon       =   "SupplierFrm.frx":0070
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex8LCtl.VSFlexGrid ogrid 
         ...
         FormatString    =   $"SupplierFrm.frx":008C
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSDFLATS.FlatComboBox searchby 
         ...
         EndProperty
         MousePointer    =   0
         MouseIcon       =   "SupplierFrm.frx":0128
      End
      Begin VB.TextBox Text1 
         Appearance      =   0  'Flat
         BorderStyle     =   0  'None
...
On Error GoTo errhandler
    ...
    sQuery = "Call sp_master_supplier_mov('" & sKodeUserAkses & "',0)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
        istatus = Normal
        MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnSupplierFrm
    End If
    oCon.Close
    Exit Sub
errhandler:
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Call sp_master_supplier_mov('" & Text1(0).text & "',1)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
    oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Call sp_master_supplier_mov('" & Text1(0).text & "',3)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Call sp_master_supplier_mov('" & Text1(0).text & "',2)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    End If
...
On Error GoTo errhandler
    If oCon.State = 1 Then oCon.Close
     oCon.Open MainModule.Conectionku(DBaseConection.Modul)
    sQuery = "Call sp_master_supplier_mov('" & Text1(0).text & "',4)"
    Set oRs = oCon.Execute(sQuery)
    If Not oRs.EOF Then
        showData
    Else
...
On Error GoTo errhandler
    If setData Then
        If oCon.State = 1 Then oCon.Close
         oCon.Open MainModule.Conectionku(DBaseConection.Modul)
        sQuery = "Delete from master_supplier where kodecustomer='" & skodecustomer & "'"
        oCon.Execute sQuery
        oCon.Close
        DoDeleteData = True
        istatus = Normal
...
On Error GoTo errhandler
    ...
    snoidsiswa = ToText(Text1(15))
    sUpdate = "call sp_master_supplier_update('"
...
Case 3
    ...
    End If
'Case 4
'    oBrowse.ShowFinder BrowsSiswa, "",ubAscending, DBaseConection.Modul
'    If Not oBrowse.YangDipilih = "" Then
...
On Error GoTo errhandler
   ...
   ' Text1(15) = ToText(ToText(oRs("noidsiswa")))
...
On Error GoTo errhandler
    ...
    sQuery = "call sp_master_produk_harga_supplier_get('"
...
On Error GoTo errhandler
    ...
    With ogrid(0)
        For irow = 1 To .Rows - 1
            sQuery = "call sp_master_produk_harga_supplier_update('" & keykodecustomer & "','"
