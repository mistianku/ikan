...
Begin VB.Form SalesmanRpt 
   BackColor       =   &H8000000A&
   Caption         =   "Master Salesman Report"
   ClientHeight    =   5835
   ClientLeft      =   -135
   ClientTop       =   645
   ClientWidth     =   10170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "SalesmanRpt.frx":0000
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "SalesmanRpt.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
sTitle = "Master Salesman Report"
'lblTitle.Caption = "  : .  " & sTitle & "  . :  "
Me.Caption = " " & sTitle & " "
MenuFrm.SetToolbarku Me, istatus, MenuFrm.sGroupUserID, mnSalesmanRpt
End Sub
...
Dim skodesalesmanfr As String
Dim skodesalesmanto As String

skodesalesmanfr = IIf(Text1(0) = "", oFindByQuery("select kodesalesman from master_salesman order by kodesalesman asc limit 1", DBaseConection.Modul), Text1(0))
skodesalesmanto = IIf(Text1(1) = "", oFindByQuery("select kodesalesman from master_salesman order by kodesalesman desc limit 1", DBaseConection.Modul), Text1(1))

Dim sKriteria As String

sKriteria = " where kodesalesman  between '" & skodesalesmanfr & "' and '" & skodesalesmanto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    master_salesman master_salesman1" & sKriteria
With arSatuanProduk
    .lblCompany1 = MenuFrm.txtHeader(0)
    .lblCompany2 = MenuFrm.txtHeader(1)
    .lblCompany3 = MenuFrm.txtHeader(2)
    .Label24.Caption = "Master Salesman Produk"
    .lblPeriode.Caption = "Kode Salesman : " & skodesalesmanfr & " s/d  " & skodesalesmanto
    .lblPeriode2.Visible = False

    .adoKu.Provider = "MSDASQL.1"
    .adoKu.ConnectionString = MainModule.Conectionku(DBaseConection.Modul)
    .adoKu.Source = sQuery
    .lblKode = "Kode salesman"
    .lblketerangan = "Nama Salesman"
    .txtkode.DataField = "kodesalesman"
    .txtketerangan.DataField = "namasalesman"
