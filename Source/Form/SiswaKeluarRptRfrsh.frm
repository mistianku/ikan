...
Begin VB.Form SiswaKeluarRptRfrsh 
   BackColor       =   &H8000000A&
   ...
   Begin VB.Frame frame1 
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "SiswaKeluarRptRfrsh.frx":0000
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VSDFLATS.FlatButton BrowseUserID 
         ...
         _ExtentX        =   873
         _ExtentY        =   450
         MouseIcon       =   "SiswaKeluarRptRfrsh.frx":001C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "SiswaKeluarRptRfrsh"
...
Me.cr1.ReportFileName = App.Path + "\Reports\SiswaKeluarRpt.Rpt"

Dim sKriteria As String
sKriteria = " Where noidsiswa between '" & snoidsiswafr & "' and '" & snoidsiswato & "' and tgldokumen between '" & stglfr & "' and '" & stglto & "'"

sQuery = "SELECT"
sQuery = sQuery & "    * "
sQuery = sQuery & " FROM "
sQuery = sQuery & "    vtransaksi_siswa_keluar_rpt vtransaksi_siswa_keluar_rpt1 " & sKriteria & " "
'
'
