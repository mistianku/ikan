VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arMasterCustomer 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arMasterCustomer.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arMasterCustomer.dsx":628A
End
Attribute VB_Name = "arMasterCustomer"
...
With arMasterCustomer.adoKu.Recordset
...
lblheader.Caption = "Status : " & IIf(arMasterCustomer.adoKu.Recordset.Fields("aktif").value = "1", "Aktif", "Tidak Aktif")
End Sub
