VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arLhppEntryRekap 
   Caption         =   "Kwitansi"
   ClientHeight    =   8430
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   15120
   Icon            =   "arLhppEntryRekap.dsx":0000
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   26670
   _ExtentY        =   14870
   SectionData     =   "arLhppEntryRekap.dsx":628A
End
Attribute VB_Name = "arLhppEntryRekap"
...
'lblCompany2.Font.Size = 7
lblCompany1.Caption = arLhppEntryRekap.adoKu.Recordset.Fields("CmnyName").value
lblalamat.Caption = arLhppEntryRekap.adoKu.Recordset.Fields("Address1").value
lblKota = arLhppEntryRekap.adoKu.Recordset.Fields("City").value
lblFax = arLhppEntryRekap.adoKu.Recordset.Fields("Faximale").value & " " & arLhppEntryRekap.adoKu.Recordset.Fields("Phone1").value
...
With arLhppEntryRekap.adoKu.Recordset
